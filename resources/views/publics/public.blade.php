...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .footer-copy { margin-top: 32px; font-size: .6rem; color: rgba(253,250,244,.2); }
        .footer-transparency {
...
<nav>
    ...
    <ul class="nav-links">
        ...
        @endif
        @if(\App\Models\Setting::isVotingOpen())
        <li><a href="{{ route('candidates') }}" class="btn-nav-vote">👑 Voter</a></li>
        @endif
    </ul>
</nav>
...
<div class="whatsapp-float">
    <a class="whatsapp-btn" id="whatsapp-share" href="#" title="Partager sur WhatsApp">📱</a>
</div>
